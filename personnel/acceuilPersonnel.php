                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content d-flex align-items-center px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="fw-bolder d-flex align-items-center fs-5" id="userName">
                                                            <!--<span id="prenom"></span>-->
                                                        </div>
                                                        <a href="#" class="fw-bold text-muted text-hover-primary fs-7" id="useremail"></a>
                    ...
                    <div class="tab-content contenu" id="nav-tabContent">
                        ...
                        <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="card card-xl-stretch mb-5 mb-xl-8 d-flex align-items-center justify-content-center">
                                ...
                                <?php } ?>
                                <h1 
                                    class="text text-primary m-5 accueil-title"
                                    style="
                                        font-size: 6rem;
                                        letter-spacing: 0.2rem;
                                        text-shadow: 2px 4px 10px rgba(0,0,0,0.15);
                                        font-weight: 900;
                                        background: linear-gradient(90deg,rgb(15, 82, 2) 10%,rgb(138, 158, 140) 100%);
